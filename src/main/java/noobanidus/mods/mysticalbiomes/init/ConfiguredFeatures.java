...
public class ConfiguredFeatures {
  ...
  public static final ConfiguredFeature<?, ?> UNCANNY_MUSHROOMS_BROWN = register("uncanny_mushrooms_brown", ModFeatures.SUPPLIER_RANDOM_PATCH.withConfiguration((new SupplierBlockClusterFeatureConfig.Builder(new LazyStateSupplier("mysticalworld", "brown_mushroom"), SimpleBlockPlacer.PLACER)).tries(64).noProjection().build()).withPlacement(Features.Placements.PATCH_PLACEMENT).chance(1));

  public static final ConfiguredFeature<?, ?> UNCANNY_MUSHROOMS_RED = register("uncanny_mushrooms_red", ModFeatures.SUPPLIER_RANDOM_PATCH.withConfiguration((new SupplierBlockClusterFeatureConfig.Builder(new LazyStateSupplier("mysticalworld", "red_mushroom"), SimpleBlockPlacer.PLACER)).tries(64).noProjection().build()).withPlacement(Features.Placements.PATCH_PLACEMENT).chance(1));

  public static final ConfiguredFeature<?, ?> UNCANNY_MUSHROOMS = register("uncanny_mushrooms", ModFeatures.SUPPLIER_RANDOM_PATCH.withConfiguration((new SupplierBlockClusterFeatureConfig.Builder(new LazyStateSupplier("mysticalworld", "uncanny_mushroom"), SimpleBlockPlacer.PLACER)).tries(64).noProjection().build()).withPlacement(Features.Placements.PATCH_PLACEMENT).chance(1));
  ...
  public static final ConfiguredFeature<?, ?> TALL_RED_MUSHROOM = register("tall_red_mushroom", ModFeatures.TALL_RED_MUSHROOM.withConfiguration(new BiggerMushroomFeatureConfig(new SimpleBlockStateProvider(Blocks.RED_MUSHROOM_BLOCK.getDefaultState().with(HugeMushroomBlock.DOWN, false)), new SimpleBlockStateProvider(Blocks.MUSHROOM_STEM.getDefaultState()), 2)));

  public static final ConfiguredFeature<?, ?> WIDE_TALL_RED_MUSHROOM = register("wide_tall_red_mushroom", ModFeatures.TALL_RED_MUSHROOM.withConfiguration(new BiggerMushroomFeatureConfig(new SimpleBlockStateProvider(Blocks.RED_MUSHROOM_BLOCK.getDefaultState().with(HugeMushroomBlock.DOWN, false)), new SimpleBlockStateProvider(Blocks.MUSHROOM_STEM.getDefaultState()), 3)));
  ...
  public static final ConfiguredFeature<?, ?> PATCH_WILD_AUBERGINE = register("patch_wild_aubergine", ModFeatures.SUPPLIER_RANDOM_PATCH.withConfiguration((new SupplierBlockClusterFeatureConfig.Builder(new LazyStateSupplier("mysticalworld", "wild_aubergine"), SimpleBlockPlacer.PLACER)).tries(64).whitelist(ImmutableSet.of(new LazyStateSupplier(Blocks.GRASS_BLOCK.getDefaultState()))).replaceable().noProjection().build()).withPlacement(Features.Placements.PATCH_PLACEMENT));

  public static final ConfiguredFeature<?, ?> PATCH_WILD_WART = register("patch_wild_wart", ModFeatures.SUPPLIER_RANDOM_PATCH.withConfiguration((new SupplierBlockClusterFeatureConfig.Builder(new LazyStateSupplier("mysticalworld", "wild_wart"), SimpleBlockPlacer.PLACER)).tries(32).whitelist(ImmutableSet.of(new LazyStateSupplier(Blocks.GRASS_BLOCK.getDefaultState()))).replaceable().noProjection().build()).withPlacement(Features.Placements.PATCH_PLACEMENT).chance(3));
  ...
  public static final ConfiguredFeature<?, ?> PATCH_STONEPETAL = register("patch_stonepetal", ModFeatures.SUPPLIER_RANDOM_PATCH.withConfiguration((new SupplierBlockClusterFeatureConfig.Builder(new LazyStateSupplier("mysticalworld", "stonepetal"), SimpleBlockPlacer.PLACER)).tries(18).build()).withPlacement(Features.Placements.VEGETATION_PLACEMENT).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).func_242731_b(2));
