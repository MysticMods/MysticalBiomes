...
public class ConfiguredSurfaceBuilders {
  ...
  public static final ConfiguredSurfaceBuilder<?> CONFIGURED_CANYONS = register("canyons", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(Blocks.SMOOTH_SANDSTONE.defaultBlockState(), Blocks.SMOOTH_SANDSTONE.defaultBlockState(), Blocks.SMOOTH_SANDSTONE.defaultBlockState())));
