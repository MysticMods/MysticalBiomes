package noobanidus.mods.mysticalbiomes.placer;
...
public class ColumnBaseBlockPlacer extends BlockPlacer {
  public static final Codec<ColumnBaseBlockPlacer> CODEC = RecordCodecBuilder.create((builder) -> builder.group(
      ...
      Codec.INT.fieldOf("peak").forGetter(o -> o.peak)).apply(builder, ColumnBaseBlockPlacer::new));
  private final int minSize;
  private final int extraSize;
  private final int radius1;
  private final int radius2;
  private final Set<LazyStateSupplier> replace;
  private final int peak;

  public ColumnBaseBlockPlacer(int minSize, int extraSize, int radius1, int radius2, List<LazyStateSupplier> replace, int peak) {
