          ...
          LootTable.builder()
              ...
              .addLootPool(
                  LootPool.builder()
                      ...
                      .addEntry(ItemLootEntry.builder(Items.EGG).weight(5).acceptFunction(SetCount.builder(RandomValueRange.of(1.0F, 4.0F))))
                      .addEntry(ItemLootEntry.builder(Items.NAME_TAG).weight(5))
                      .addEntry(ItemLootEntry.builder(Items.CHARCOAL).weight(5).acceptFunction(SetCount.builder(RandomValueRange.of(1.0F, 4.0F))))
                      ...
                      .addEntry(ItemLootEntry.builder(ModItems.VEGETABLE_JUICE.get()).weight(5).acceptFunction(SetCount.builder(RandomValueRange.of(1.0F, 4.0F))))
                      .addEntry(ItemLootEntry.builder(ModItems.APPLE_CORDIAL.get()).weight(5).acceptFunction(SetCount.builder(RandomValueRange.of(1.0F, 4.0F))))
                      .addEntry(ItemLootEntry.builder(ModItems.DANDELION_CORDIAL.get()).weight(5).acceptFunction(SetCount.builder(RandomValueRange.of(1.0F, 4.0F))))
                      .addEntry(ItemLootEntry.builder(Items.LEAD).weight(5))
              )
              .addLootPool(
                  LootPool.builder()
