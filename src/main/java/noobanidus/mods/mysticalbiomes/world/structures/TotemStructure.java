...
public class TotemStructure extends SimpleStructure {
  public TotemStructure(Codec<NoFeatureConfig> codec) {
    super(codec);
  }
  ...
  public static class Start extends SimpleStart {
    ...
    public static ResourceLocation POOL = new ResourceLocation(MysticalBiomes.MODID, "totem_pool/start_pool");
