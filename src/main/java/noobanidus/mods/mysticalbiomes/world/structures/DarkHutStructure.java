...
public class DarkHutStructure extends SimpleStructure {
  public DarkHutStructure(Codec<NoFeatureConfig> codec) {
    super(codec);
  }

  @Override
  public IStartFactory<NoFeatureConfig> getStartFactory() {
    return DarkHutStructure.Start::new;
  }
  ...
  public static class Start extends SimpleStart {
    ...
    public static ResourceLocation POOL = new ResourceLocation(MysticalBiomes.MODID, "dark_hut_pool/start_pool");
