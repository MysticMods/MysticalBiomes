...
public class SupplierDefaultSurfaceBuilder extends SurfaceBuilder<SupplierSurfaceBuilderConfig> {
  public SupplierDefaultSurfaceBuilder(Codec<SupplierSurfaceBuilderConfig> p_i232124_1_) {
    super(p_i232124_1_);
  }
